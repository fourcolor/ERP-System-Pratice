<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insertReceipt.aspx.cs" Inherits="Database.WebForm2" EnableEventValidation="False" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" ShowFooter="True" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" DataKeyNames="orderID,SERIALNUMBER" OnDataBound="GridView1_DataBound">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="實收數量" SortExpression="shipped">
                    ...
                    <ItemTemplate>
                        <asp:TextBox ID="Label17" runat="server" Width="75px" Text='<%# Bind("shipped") %>' OnTextChanged="Label17_TextChanged"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="缺貨">
                    ...
                    <ItemTemplate>
                        <asp:TextBox ID="Label222" Width="75px" runat="server" Text='<%# Bind("outofstock") %>' OnTextChanged="Label222_TextChanged"></asp:TextBox>
                    </ItemTemplate>
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="其他">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text ='<%# Bind("other") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="other" runat="server" Text="" Width="75px"></asp:TextBox>
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ShowHeader="False">
                    ...
                    <FooterTemplate>
                        ...
                        <asp:Button ID="otherButton" runat="server" Text="其他" OnClick="productIDLabel_Click"></asp:Button>
                    </FooterTemplate>
                </asp:TemplateField>
            </Columns>
